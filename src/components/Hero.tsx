      ...
      <Card className="w-full max-w-6xl mx-auto bg-background relative overflow-hidden border-0">
        ...
        <div className="flex flex-col md:flex-row h-full min-h-[500px]">
          <div className="flex-1 p-8 relative z-10 flex flex-col justify-center">
            ...
            >
              <h1 className="text-4xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 leading-tight md:leading-normal pb-2">
