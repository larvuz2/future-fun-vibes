  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        >
          <div className="absolute w-[100%] left-0 bg-background h-40 top-0 z-20 [mask-image:linear-gradient(to_bottom,white,transparent)]" />
          <div className="absolute w-40 h-[100%] left-0 bg-background top-0 z-20 [mask-image:linear-gradient(to_right,white,transparent)]" />
        </motion.div>
        <motion.div
          initial={{ opacity: 0.5, width: "15rem" }}
          whileInView={{ opacity: 1, width: "30rem" }}
        ...
        >
          <div className="absolute w-40 h-[100%] right-0 bg-background top-0 z-20 [mask-image:linear-gradient(to_left,white,transparent)]" />
          <div className="absolute w-[100%] right-0 bg-background h-40 top-0 z-20 [mask-image:linear-gradient(to_bottom,white,transparent)]" />
        </motion.div>
        <div className="absolute bottom-1/2 h-48 w-full -translate-y-12 scale-x-150 bg-background blur-2xl"></div>
        <div className="absolute bottom-1/2 z-50 h-48 w-full bg-transparent opacity-10 backdrop-blur-md"></div>
