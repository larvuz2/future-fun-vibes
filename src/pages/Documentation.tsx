...
const Documentation = () => {
  ...
  const contentMap: { [key: string]: string } = {
    ...
    // For Gamers section
    "unlocking": `Players buy a game's token to access its premium content. These tokens act as the gateway to exclusive gameplay features, creating a direct and simple connection between players and the game.`,
    "supporting": `When players purchase tokens, they directly fund the game's development. This creates a transparent and meaningful way to support indie developers while enjoying the game.`,
    "gaming": `Future.fun's streaming technology ensures players can enjoy high-quality, compute-intensive games on any device, including smartphones. The token system keeps access seamless and efficient.`,
    "rewards": `Future.fun's streaming technology ensures players can enjoy high-quality, compute-intensive games on any device, including smartphones. The token system keeps access seamless and efficient.`,
    
    // For Developers section
    "who-should": `Future.fun is ideal for developers creating high-quality, compute-intensive games using engines like Unreal Engine, Unity or compute-intensive diffusion pipelines. Whether you're an indie studio or an established creator, the platform simplifies funding and engagement for visually rich, immersive gaming experiences.`,
    "token-creation": `Developers can easily mint tokens tied to their games through an intuitive interface. Each token is unique to the game, offering branding, ticker customization, and immediate utility as a gateway to premium features.`,
    "distributing": `Future.fun allows developers to release early prototypes or pilot versions of their games, token-gated to attract early adopters. This enables developers to gather community feedback, refine gameplay, and build momentum before a full release.`,
    "earning": `Every token purchase directly funds your game, providing immediate revenue to support development. As your game attracts more players, the demand for its tokens increases, ensuring sustained growth and financial viability. This dynamic rewards developers who focus on quality and engagement.`,
    
    // Tokenomics section
    "how-tokens": `Tokens are minted for each game and act as access keys to unlock premium content. Players buy these tokens to experience advanced game features, directly funding the game's development. The token price follows a bonding curve—a dynamic pricing model where the price increases as more tokens are purchased. This rewards early supporters and ties token value to the game's popularity and demand.`,
    "fair-launch": `Each game token follows a fair launch principle, ensuring equal access to everyone:
    ...
    "fee-structure": `A transaction fee (4.5%) is applied to all token transactions, distributed as follows:
    ...
    "incentives": `For Gamers: Tokens unlock premium experiences, offering direct value for their support.
    For Developers: Developers earn revenue with every token transaction tied to their game, enabling sustainable development.`,
    "solana": `Future.fun leverages the Solana blockchain for its token infrastructure, ensuring:
    ...
    // Technology section
    "streaming": `Future.fun utilizes state-of-the-art streaming technology combined with AI-driven pipelines to deliver high-quality, immersive gaming experiences. This ensures smooth gameplay, advanced visuals, and real-time rendering, powered entirely in the cloud.`,
    "compute": `Players can enjoy visually rich, compute-intensive games without needing high-end hardware. The platform processes and streams gameplay from its robust cloud infrastructure, making premium gaming accessible on smartphones, tablets, and other devices.`,
    "quality": `Future.fun's technology offloads demanding compute tasks to the cloud, reducing the burden on players' devices. By combining efficient streaming with Unreal Engine and Unity support, the platform delivers a seamless, high-quality experience regardless of device capabilities.`,
    
    // Community section
    "token-holders": `Token holders play a vital role in the Future.fun ecosystem. By purchasing and holding game tokens, they:
    ...
    "governance": `Future.fun fosters a collaborative environment where the community can shape the platform's future:
    ...
    "ecosystem": `Future.fun bridges the gap between developers and gamers, creating a mutually beneficial ecosystem:
    ...
    "for-gamers": `Choose a Game: Explore the platform to find a game you want to play.
    ...
    "for-devs": `Create an Account: Sign up on Future.fun and access the developer dashboard.
    ...
    "faqs": `How long does approval take for developers? Approvals typically take a few days, depending on the volume of submissions and the complexity of your game.
    ...
    "planned": `Enhanced Developer Tools: Simplified interfaces for token creation and game submission, along with analytics dashboards to track player engagement and token performance.
    ...
    "expanding": `More Game Integrations: Support for additional game engines, ensuring compatibility with a wider range of developers.
    ...
    "vision": `Future.fun aims to redefine how games and experiences are funded, played, and sustained:
    ...
    "transparency": `Fair Token Launches: All tokens are launched without pre-sales or reserved allocations, ensuring equal access for all participants.
    ...
    "regional": `Regulatory Adherence: The platform actively complies with regional and international laws to ensure smooth operations and user safety.
    ...
    "security": `Blockchain Security: Tokens and transactions leverage Solana's robust and secure blockchain infrastructure to protect against fraud and tampering.
